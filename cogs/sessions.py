...
class sessions(commands.Cog):
    ...
    async def poll(self, interaction : discord.Interaction, votes : int):
        ...
        embed.set_image(url="https://media.discordapp.net/attachments/1305242815093014528/1305243785026076793/NYCSSUVote.webp?ex=67325280&is=67310100&hm=9c73f961c07e28f0c65aee9720373c410e50c8b572fec0564718b0685c17aec4&=&format=webp")
    ...
    async def ssu(self, interaction: discord.Interaction):
        ...
        embed.set_image(url="https://media.discordapp.net/attachments/1305242815093014528/1305243766579531836/NYCSSU.webp?ex=6732527c&is=673100fc&hm=c41b58a8a218f8ddce96edc76f8268c71654aa6edaed694538b7bf850c05897c&=&format=webp")
    ...
    async def ssd(self, interaction: discord.Interaction):
        ...
        embed.set_image(url="https://media.discordapp.net/attachments/1305242815093014528/1305243766961078395/NYCSSD.webp?ex=6732527c&is=673100fc&hm=c8d4bb0181df7ed19ec447b4e78959e460ffa33a72dad1bdecfe7d180e954918&=&format=webp")
